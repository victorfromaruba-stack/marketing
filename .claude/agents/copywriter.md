...
**No dashes as sentence breaks.** Never an em dash or en dash joining clauses, in site copy,
emails, subject lines, alt text or titles. Use a full stop, a comma or a colon. Hyphens inside
compound words are fine. QA fails the build on this.
